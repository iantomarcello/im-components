...
TODO:
- Select that is customizable (see https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Forms/Customizable_select)
- Textarea that has field-sizing by default.